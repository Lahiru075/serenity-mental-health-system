...
public class PatientManageController implements Initializable {
    ...
    @FXML
    private Button btnPatientPrograms;
    ...
    @FXML
    void btnPatientProgramsOnAction(ActionEvent event) {
    ...
    void btnSaveOnAction(ActionEvent event) throws SQLException {
        ...
        boolean isValidEmail = name.matches(emailPattern);
        boolean isValidContact = name.matches(contactPattern);
        boolean isValidDescription = name.matches(descriptionPattern);
