...
public class TherapySessionBoImpl implements TherapySessionBo {
    ...
    @Override
    public ArrayList<TherapySessionDto> checkByTherapistId(String id) {
        ArrayList<TherapySession> therapySessions = therapySessionDao.checkByTherapistId(id);
    ...
    @Override
    public ArrayList<TherapySessionDto> getAllCounts(String therapistId, String therapyProgramId) {
        ArrayList<TherapySession> therapySessions = therapySessionDao.getAllCounts(therapistId, therapyProgramId);
    ...
    @Override
    public ArrayList<TherapySessionDto> getSessionByPatientId(String patientId) {
        ArrayList<TherapySession> therapySessions = therapySessionDao.getSessionByPatientId(patientId);
